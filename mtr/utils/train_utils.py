...
class EarlyStopping():
    ...
    def __call__(self, valid_loss, best_valid_loss):
...
class Logger(SummaryWriter):
    ...
    def log_audio_acc(self, acc, epochs):
        self.add_scalar('audio_acc', acc, epochs)

    def log_text_acc(self, acc, epochs):
        self.add_scalar('text_acc', acc, epochs)
